...
public class supprimiuserconteoller {
	private int updateValue;
	public void yes2 (ActionEvent event) throws IOException, SQLException {
		String query = "DELETE FROM example.user WHERE id = " +updateValue ;
